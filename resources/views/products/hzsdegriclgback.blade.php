...
<div>
    ...
    <div class="center3">{!! QrCode::size(120)->backgroundColor(255,255,255)->generate('BM201603'); !!}</div>
    <h1 style="color: black; font-size: 17px; font-weight:blod; text-align:center; margin-top:15px;">ROMJAN AHAMED SOBUJ</h1>
